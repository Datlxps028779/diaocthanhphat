...
-- =============================================================================
-- BƯỚC 7: SEO Fields — Thêm focus_keywords, schema_markup, meta fields
-- Xem chi tiết tại: supabase/migrations/20260704500000_seo_fields.sql
-- =============================================================================
...
-- ─── Reload PostgREST schema cache (QUAN TRỌNG) ──────────────────────────────
-- Báo PostgREST đọc lại schema để nhận biết các cột mới (fix lỗi PGRST204)
