...
export function LocalityPriceTable({ rows }: { rows: LocalityPriceRow[] }) {
  return <div className={`${styles.scope} ${styles.tableFrame}`}>
    <table className="w-full min-w-[660px] border-collapse text-left text-sm">
      <caption className="border-b border-stone-100 bg-stone-50/70 px-4 py-4 text-left text-xs leading-6 text-stone-500">Giá chào từ tin đăng trên Chợ Nhà Việt, không phải giá giao dịch hay đại diện toàn thị trường. Từng chỉ số cần ít nhất 3 mẫu hợp lệ.</caption>
