...
function buildSystemPrompt(): string {
  return [
    ...
    '- Mở đầu bằng mục <h2>Câu trả lời nhanh</h2> trả lời trực tiếp ý định tìm kiếm trong 2-3 câu (tối ưu cho AI Overview/đoạn trích nổi bật).',
    ...
    '- CẤU TRÚC PHÂN CẤP RÕ RÀNG: ít nhất 4-6 mục <h2> (ngoài "Câu trả lời nhanh"), mỗi <h2> có 2-4 đoạn <p> và nên có 1-2 tiểu mục <h3> khi hợp lý.',
    ...
    '- Mỗi đoạn <p> dài 2-4 câu, mạch lạc. Dùng <ul>/<ol> cho danh sách và <table> khi so sánh số liệu/khu vực để tăng khả năng được AI trích dẫn.',
    '- Kết bài bằng 1 mục <h2> tổng kết + gợi ý bước tiếp theo (KHÔNG phải FAQ).',
    ...
    '  "contentHtml": "Thân bài HTML sạch 900-1400 từ: mở đầu <h2>Câu trả lời nhanh</h2> + <p>, rồi 4-6 mục <h2> (mỗi mục 2-4 <p>, có <h3> tiểu mục khi hợp lý), dùng <ul>/<ol>/<table> để cấu trúc, kết bằng <h2> tổng kết. KHÔNG <script>, KHÔNG JSON-LD, KHÔNG <h1> lặp tiêu đề. TUYỆT ĐỐI KHÔNG chèn mục FAQ / Câu hỏi thường gặp vào thân bài — FAQ nằm RIÊNG ở khoá faq",',
