...
describe('measurement', () => {
  ...
  it('summarizes CRM assignment, activity and timestamp-backed follow-up evidence', () => {
    expect(crmMeasurement([
      { assigneeCount: 1, activityCount: 2, followUpAt: '2026-09-04T10:00:00Z' },
      { assigneeCount: 0, activityCount: 0, followUpAt: null },
      { assigneeCount: 2, activityCount: 1, followUpAt: '2026-09-06T10:00:00Z' },
    ...
    expect(crmMeasurement([
      { assigneeCount: 0, activityCount: 0, followUpAt: null },
    ], new Date('2026-09-05T10:00:00Z')).overdueFollowUps).toBeNull();
  });
});
