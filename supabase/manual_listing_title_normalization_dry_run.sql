...
-- Candidate only. Do not update from this report until source evidence and a guarded apply scope are approved.
-- =============================================================================
...
SELECT
  ...
  'Candidate only. No mutation from this report until source evidence and a guarded apply scope are approved.' AS notes
FROM classified
